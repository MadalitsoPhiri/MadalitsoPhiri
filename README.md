...
*2020*
- Developed **VoIP mobile application** combining WhatsApp-like chat with cell service calling capabilities
- Prototyped with React Native before transitioning to native **Kotlin** to optimize performance and handle SIP trucking
- Implemented **Node.js backend** for call routing and user management
- Optimized app to handle 100+ concurrent users without degradation

### **Full Stack Developer** | GreenWebb (Startup)
*2020*
- Built web application using **PHP and MySQL**, handling user authentication and data management
- Designed responsive front-end with **HTML/CSS**, achieving mobile-first design principles

### **Full Stack Freelancer** | Upwork
*2020*
- **3 completed projects** with 100% client satisfaction
- Built **data synchronization backend** using Node.js, syncing between 2 distributed data stores
- Developed React Native mobile application features
- Authored comprehensive **endpoint test suite** for API validation
- [Upwork Profile](https://www.upwork.com/freelancers/~014a5ea5e7810e201f)
...
- Google Cloud (Cloud Run, App Engine, Cloud SQL, Cloud Storage, Firebase)
- Docker, Docker Compose, Nginx, Linux/Bash scripting
- CI/CD, SSL certificate management, VPS deployment

### **Frontend & Styling**
- React Hooks, Component-driven architecture
- Tailwind CSS, Styled Components, CSS-in-JS
- Responsive design, Webpack, Babel

### **Real-time & Integration**
- Socket.io (real-time chat, live notifications)
- GraphQL (Apollo Server/Client)
- REST API design and optimization
- Google Dialogflow, Firebase Cloud Functions

### **Quality Assurance & Architecture**
- Jest, Chai, Enzyme (unit and integration testing)
...
**FIA Diploma in Accountancy & Business**  
Zabtuc College of Business | 2019

**Certificate in Web Design**  
FreeCodeCamp | 2020
- [Responsive Web Design](https://freecodecamp.org/certification/fccc343da18-dcc1-48c2-b315-11564ea8f4c0/responsive-web-design)
